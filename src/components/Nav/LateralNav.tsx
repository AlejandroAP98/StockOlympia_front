        ...
        <div className="relative mt-4 w-full h-full py-12  ">
          {id_rol === rolesMapping.admin? (
            ...
            >
              ...
              <span className="ml-2 hidden group-hover:inline font-semibold">Usuarios</span>
            </button>
            <button
            ...
            >
              ...
              <span className="ml-2 hidden group-hover:inline font-semibold">Salas</span>
            ...
            >
              ...
              <span className="ml-2 hidden group-hover:inline font-semibold">Productos</span>
              </button>
              ...
              <button
                ...
                <span className="ml-2 hidden group-hover:inline font-semibold">Marcas</span>
              </button>
              <button
                ...
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                  ...
                  <span className="ml-2 hidden group-hover:inline font-semibold ">Categorias</span>
                </button>
                <button
                ...
                >
                  ...
                  <span className="ml-2 hidden group-hover:inline font-semibold">Casinos</span>
                </button>
                <button
              ...
              <>
                ...
                >
                  ...
                  <span className="ml-2 hidden group-hover:block font-semibold">Productos</span>
                </button>
                <button
                ...
                > 
                  ...
                  <span className="ml-2 hidden group-hover:inline font-semibold">Ingresos</span>
                </button>
                <button
                  onClick={() => setActiveView("movimientos")}
                  className="flex items-center justify-between group-hover:justify-start w-full px-4 py-2 text-base dark:hover:bg-accent-dark hover:bg-accent-light/50 hover:dark:text-textColor-light"
